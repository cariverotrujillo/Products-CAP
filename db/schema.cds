...
context sales {
    ...
    entity OrderItems : cuid {
        ...
        Product : Association to materials.ProjProducts;
    }
    ...
    entity SelProduct   as select from materials.Products;
